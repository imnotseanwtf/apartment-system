            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mt-3">
                        <label for="name">{{ __('Occupation') }}</label>
                        <div class="input-group">
                            <input name="occupation" type="text" id="view_occupation" @class(['form-control']) placeholder="{{ __('occupation') }}" value="{{ old('occupation') }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <div class="input-group">
                            <input name="number" type="text" id="view_number" @class(['form-control']) placeholder="{{ __('No.') }}" value="{{ old('number') }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group mt-3">
                        <label for="name">{{ __('Email') }}</label>
                        <div class="input-group">
                            <input name="email" type="text" id="view_email" @class(['form-control']) placeholder="{{ __('email') }}" value="{{ old('email') }}" readonly>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
